...
{
    [Bot("SnapioStrategyForFourEmaAOAndMacdHistogram")] // We create an attribute so that we don't write anything to the BotFactory
    public class SnapioStrategyForFourEmaAOAndMacdHistogram : BotPanel
    {
        ...
        public SnapioStrategyForFourEmaAOAndMacdHistogram(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            ParametrsChangeByUser += SnapioStrategyForFourEmaAOAndMacdHistogram_ParametrsChangeByUser;
        ...
        private void SnapioStrategyForFourEmaAOAndMacdHistogram_ParametrsChangeByUser()
        {
            ((IndicatorParameterInt)_EmaFastLoc.Parameters[0]).ValueInt = PeriodEmaFastLoc.ValueInt;
            _EmaFastLoc.Save();
            _EmaFastLoc.Reload();
        ...
        {
            return "SnapioStrategyForFourEmaAOAndMacdHistogram";
        }
